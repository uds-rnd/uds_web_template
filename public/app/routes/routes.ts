...
import { FabImgView } from 'app/core/components/FabPage/FabImgView';
import { FabCardView } from 'app/core/components/FabPage/FabCardView';
...
export function setupAngularRoutes($routeProvider: route.IRouteProvider, $locationProvider: ILocationProvider) {
  ...
  $routeProvider
    .when('/', {
      redirectTo: config.datasources.Setting && config.datasources.Setting.jsonData.fabUrl ? '/fabi' : '/home',
    })
    .when('/home', {
